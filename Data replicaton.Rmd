...
They find that a possible mechanism by which larval nutrition could effect adult weight gain and strength is through a insulin like signaling pathway. 

I used the data that they provided.



I will be recreating the sexual dimorphism in in pronotum length vs Elytra in horned beetles 
...
I replace the data female data. with the data female beetle . the rest of the code was simple 
```{r}
